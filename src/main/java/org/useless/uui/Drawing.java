 ...
 * @see Brush 绘图使用的画笔工具
 * @see Color 颜色类
 * @see org.useless.uui.data.Location 位置信息类
 * @see org.useless.uui.data.Size 尺寸信息类
 * @since 1.0
 */
public interface Drawing {
     ...
     * </p>
     *
     * @param awtColor 要设置的颜色对象，使用RGB颜色模型
     * @deprecated 因为我的 {@code Color} 在转换为awt的颜色时有bug
     */
    @Deprecated
    void setAwtColor(java.awt.Color awtColor);
     ...
     * @param font 字体
     * @see java.awt.Font
     * @deprecated 已经没用了但是懒得删
     */
    @Deprecated
    void setAWTFont(java.awt.Font font);
    ...
    void drawRoundedRectangle(
            ...
            float height, float w, float h, float arc
    );
    ...
    void drawRRS(float x, float y, float w, float h, float arcW, float arcH, float lineWidth, Color color);
    ...
    /**
     * 渲染文本<br>
     * 使用{@code AWT FONT} 进行渲染文本<br>
     * 并且有bug，在渲染文本时现实的文本偏暗
     * @param text 文本
     * @param x 横向坐标
     * @param y 纵向坐标
     * @see java.awt.Font
     * @deprecated 能用但是已经有文本渲染了
     * @since 0.0.2
     */
    @Deprecated
    void drawAWTText(String text, int x, int y);
    ...
    /**
     * 控制字体变体的警告信息默认为{@code false}
     * @param show 状态
     * @see Font
     * @see Brush
     */
    // 添加静态方法控制警告显示
    void setShowVariantWarnings(boolean show);
     ...
     * @param handle 句柄
     * @param size 窗口大小
     * @param mouseLocation 鼠标坐标
     * @param nvgContext 字体
     */
    void deliverHandle(long handle, Size size, Location mouseLocation, long nvgContext);
